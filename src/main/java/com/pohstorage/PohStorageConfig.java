...
public interface PohStorageConfig extends Config
{
	...
	enum outlineColor {
		GREEN("Green", SpriteID.UNKNOWN_GREEN_BAR),
		BLUE("Blue", SpriteID.UNKNOWN_BLUE_BAR),
		YELLOW("Yellow", SpriteID.UNKNOWN_YELLOW_BAR),
		RED("Red", SpriteID.UNKNOWN_RED_BAR),
		NONE("None", 0)
		;
	...
	default preserveFilters preserveFilters() { return preserveFilters.WITHIN_SESSION; }
	...
	default outlineColor fullSetColor() { return outlineColor.GREEN; }
	...
	default outlineColor partialSetColor() { return outlineColor.BLUE; }
	...
	default outlineColor emptySetColor() { return outlineColor.NONE; }
	...
	default int shadeOpacity() { return 230; }
	...
	default boolean showPartialSets() { return true; }
	...
	default boolean showEmptySets() { return true; }
